...
public partial class admin_Insert_Tutor : System.Web.UI.Page
{
    ...
    protected void Tutor_Insert_Button_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (a > 0)
            {
                ScriptManager.RegisterStartupScript(this, GetType(), "Popup", "Swal.fire('Success','Tutor Data Insert Successfully','success')", true);
                clear_textbox();
            }
            else
            {
