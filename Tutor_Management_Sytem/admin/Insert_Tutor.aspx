<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin_Dashboard.master" AutoEventWireup="true" CodeFile="Insert_Tutor.aspx.cs" Inherits="admin_Insert_Tutor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="container" id="Design">
        ...
        <div class="row mb-5">
            <h1 class="mt-4 p-5 bg-dark text-light rounded text-center ">INSERT NEW TUTOR DATA</h1>
        </div>
        <div class="row">
            <div class="col-md-4">
                ...
                <asp:rangevalidator id="RangeValidator1" runat="server" controltovalidate="Age_Box" setfocusonerror="true" display="Dynamic" forecolor="Red" errormessage="Enter Age Between 5 to 60" maximumvalue="60" minimumvalue="20"></asp:rangevalidator>
                <br />
            ...
            <div class="row">
                <div class="col-md-3 d-grid mx-auto mt-3">
                    <asp:button id="Tutor_Insert_Button" onclick="Tutor_Insert_Button_Click" runat="server" text="Insert" cssclass="btn btn-dark btn-block" />
                </div>
            </div>
        </div>
    </div>
