<%@ Page Title="" Language="C#" MasterPageFile="~/Index.master" AutoEventWireup="true" CodeFile="Student_Signup.aspx.cs" Inherits="Student_Signup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="container" id="Design">
        ...
        <div class="row mb-5">
            <h1 class="mt-4 p-5 bg-primary text-light rounded text-center ">Student SignUp</h1>
        </div>
        <div class="row">
            <div class="col-md-4">
                ...
                <br />
                <asp:textbox id="Age_Box_1" cssclass="form-control" placeholder="Enter Age" runat="server"></asp:textbox>
                <asp:rangevalidator runat="server" errormessage="Enter Age Between 5 To 40" id="Age_Range" controltovalidate="Age_Box_1" display="Dynamic" forecolor="Red" maximumvalue="40" minimumvalue="5" setfocusonerror="True" type="Integer"></asp:rangevalidator>
                <asp:requiredfieldvalidator id="RequiredFieldValidator5" runat="server" controltovalidate="Age_Box_1" setfocusonerror="true" display="Dynamic" forecolor="Red" errormessage="Age is Required"></asp:requiredfieldvalidator>
            ...
            <div class="row">
                <div class="col-md-3 d-grid mx-auto mt-5">
                    <asp:button id="Signup_Button" onclick="Signup_Button_Click" runat="server" text="Signup" cssclass="btn btn-primary btn-block" />
                </div>
                <div class="text-center mt-1">
                    <a href="Student_Login.aspx" class="text-dark align-content-center">Already Have Account ? Login Now</a>
                </div>
            </div>
            <div class="row ">
                <div class="col-md-4  mt-3 clearfix text-center mx-auto">
                    <a href="Tutor_Signup.aspx" class="btn btn-outline-primary  ">Signup As Tutor</a>
                    <a href="Default.aspx" class="btn btn-outline-primary float-end ">Go To Home Page</a>
                </div>
